...
- Page-based pagination assumed based on README examples (other Pax8 APIs besides Companies)
- Edge cases address primaryContact conflicts, orphan contacts, and duplicate emails
