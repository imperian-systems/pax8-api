# Data Model: Quotes API

**Generated by**: `/speckit.plan` Phase 1

## Overview

TypeScript type definitions for Quotes API entities, based on Pax8 Quoting Endpoints v2 OpenAPI specification.
...
Represents a sales proposal/quote.
...
**Source**: Pax8 Quoting API v2 OpenAPI - Quote component

---

### LineItem

Represents a product/service line item within a quote.
...
**Source**: Pax8 Quoting API v2 OpenAPI - LineItem component

---

### Line Item Payloads (Discriminated Union)
...
**Source**: Pax8 Quoting API v2 OpenAPI - AddLineItemPayload, UpdateLineItemPayload
